"""source: https://github.com/pedro-morgado/spatialaudiogen/blob/master/pyutils/ambisonics/common.py"""

from .position import Position
from math import sqrt, pi, factorial
import numpy as np

# for ordering, check: https://en.wikipedia.org/wiki/Ambisonic_data_exchange_formats
